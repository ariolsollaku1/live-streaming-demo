...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  toggleSwitchInput.addEventListener('change', () => {
    toggleChatHistory(toggleSwitchInput.checked);
  });
});

function toggleChatHistory(showChat) {
  const talkVideo = document.getElementById('talk-video');
...
function updateChatHistory() {
  ...
  conversationHistory.forEach((message) => {
    ...
    messageElement.textContent = message.content; // Extract content from the message object
...
function displayChatHistory() {
 ...
 function addUserMessage(message) {
  conversationHistory.push({ role: "system", content: message }); // Create a message object
  updateChatHistory();
}

// Function to add an assistant message to the conversation history
function addAssistantMessage(message) {
  conversationHistory.push({ role: "assistant", content: message }); // Create a message object
  updateChatHistory();
}

// Modify the code where you add user messages
const userMessage = 'Hello, this is a user message.';
addUserMessage(userMessage);

// Modify the code where you add assistant messages
const assistantMessage = 'Hi, I am the Chat gpt assistant.';
...
async function onSendMessage() {
  ...
  conversationHistory.push({ role: "system", content: nameInput });
